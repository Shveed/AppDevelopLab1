...
public class WriteNumbers {
    ...
    public static String digitsToText(int d){
        ...
        threeChars.peek().ran = Ranges.UNITS;
        ...
        for(int i = 0; i < sb.length(); i++){
            ...
            switch(i){
                case 0:
                    ...
                    break;
                case 3:
                    threeChar.ran = Ranges.THOUSANDS;
                    threeChar.u = sb.charAt(i);
                    break;
                case 6:
                    threeChar.ran = Ranges.MILLIONS;
                    threeChar.u = sb.charAt(i);
                    break;
                case 9:
                    threeChar.ran = Ranges.BILLIONS;
                    threeChar.u = sb.charAt(i);
                    break;
                case 2:
                case 5:
        ...
        while(!threeChars.isEmpty()){
            ...
            if (temp.h == '0' && temp.d == '0' && temp.u == '0') continue;
            if(temp.h > '0') {
            ...
            if(temp.u > '0' && temp.d != '1') {
                result.append(getUnits(temp.u, temp.ran == Ranges.THOUSANDS));
                result.append(' ');
            }
            switch(temp.ran){
                case BILLIONS:
